    ...
    module: {
      ...
      loaders: [
        ...
        },
        {
          ...
          loader:
            "url?limit=10000&mimetype=application/font-woff&name=assets/fonts/[name].[ext]"
        },
        {
          test: /\.ttf(\?v=\d+.\d+.\d+)?$/,
          loader:
            "url?limit=10000&mimetype=application/octet-stream&name=assets/fonts/[name].[ext]"
        },
        {
          test: /\.svg(\?v=\d+.\d+.\d+)?$/,
          loader:
            "url?limit=10000&mimetype=image/svg+xml&name=assets/fonts/[name].[ext]"
        },
        {
